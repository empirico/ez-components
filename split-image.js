const N = globalThis, j = N.ShadowRoot && (N.ShadyCSS === void 0 || N.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, B = /* @__PURE__ */ Symbol(), J = /* @__PURE__ */ new WeakMap();
let rt = class {
  constructor(t, e, s) {
...
const { is: ct, defineProperty: ut, getOwnPropertyDescriptor: _t, getOwnPropertyNames: gt, getOwnPropertySymbols: $t, getPrototypeOf: ft } = Object, D = globalThis, G = D.trustedTypes, yt = G ? G.emptyScript : "", vt = D.reactiveElementPolyfillSupport, E = (r, t) => r, R = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? yt : null;
      break;
  ...
  return e;
} }, q = (r, t) => !ct(r, t), X = { attribute: !0, type: String, converter: R, reflect: !1, useDefault: !1, hasChanged: q };
...
let A = class extends HTMLElement {
  ...
  _$AK(t, e) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const o = s.getPropertyOptions(i), n = typeof o.converter == "function" ? { fromAttribute: o.converter } : o.converter?.fromAttribute !== void 0 ? o.converter : R;
      this._$Em = i;
...
A.elementStyles = [], A.shadowRootOptions = { mode: "open" }, A[E("elementProperties")] = /* @__PURE__ */ new Map(), A[E("finalized")] = /* @__PURE__ */ new Map(), vt?.({ ReactiveElement: A }), (D.reactiveElementVersions ??= []).push("2.1.2");
const F = globalThis, Y = (r) => r, H = F.trustedTypes, K = H ? H.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, nt = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, at = "?" + y, mt = `<${at}>`, b = document, x = () => b.createComment(""), T = (r) => r === null || typeof r != "object" && typeof r != "function", W = Array.isArray, bt = (r) => W(r) || typeof r?.[Symbol.iterator] == "function", L = `[ 	
\f\r]`, P = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Q = /-->/g, tt = />/g, v = RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), et = /'/g, st = /"/g, ht = /^(?:script|style|textarea|title)$/i, At = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), z = At(1), w = /* @__PURE__ */ Symbol.for("lit-noChange"), _ = /* @__PURE__ */ Symbol.for("lit-nothing"), it = /* @__PURE__ */ new WeakMap(), m = b.createTreeWalker(b, 129);
function lt(r, t) {
...
const wt = (r, t) => {
  ...
  for (let h = 0; h < e; h++) {
    const a = r[h];
    let u, g, p = -1, $ = 0;
    for (; $ < a.length && (n.lastIndex = $, g = n.exec(a), g !== null); ) $ = n.lastIndex, n === P ? g[1] === "!--" ? n = Q : g[1] !== void 0 ? n = tt : g[2] !== void 0 ? (ht.test(g[2]) && (i = RegExp("</" + g[2], "g")), n = v) : g[3] !== void 0 && (n = v) : n === v ? g[0] === ">" ? (n = i ?? P, p = -1) : g[1] === void 0 ? p = -2 : (p = n.lastIndex - g[2].length, u = g[1], n = g[3] === void 0 ? v : g[3] === '"' ? st : et) : n === st || n === et ? n = v : n === Q || n === tt ? n = P : (n = v, i = void 0);
    const f = n === v && r[h + 1].startsWith("/>") ? " " : "";
    o += n === P ? a + mt : p >= 0 ? (s.push(u), a.slice(0, p) + nt + a.slice(p) + y + f) : a + y + (p === -2 ? h : f);
  }
    ...
    for (; (i = m.nextNode()) !== null && a.length < h; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const p of i.getAttributeNames()) if (p.endsWith(nt)) {
          const $ = g[n++], f = i.getAttribute(p).split(y), U = /([.?@])?(.*)/.exec($);
          a.push({ type: 1, index: o, name: U[2], strings: f, ctor: U[1] === "." ? Pt : U[1] === "?" ? Et : U[1] === "@" ? Ct : k }), i.removeAttribute(p);
        } else p.startsWith(y) && (a.push({ type: 6, index: o }), i.removeAttribute(p));
        if (ht.test(i.tagName)) {
          const p = i.textContent.split(y), $ = p.length - 1;
          if ($ > 0) {
            i.textContent = H ? H.emptyScript : "";
            for (let f = 0; f < $; f++) i.append(p[f], x()), m.nextNode(), a.push({ type: 2, index: ++o });
            i.append(p[$], x());
          }
        }
        ...
        let p = -1;
        for (; (p = i.data.indexOf(y, p + 1)) !== -1; ) a.push({ type: 7, index: o }), p += y.length - 1;
      }
      o++;
    }
  }
...
class St {
  ...
  u(t) {
    ...
    for (; a !== void 0; ) {
      if (n === a.index) {
        let u;
        a.type === 2 ? u = new O(o, o.nextSibling, this, t) : a.type === 1 ? u = new a.ctor(o, a.name, a.strings, this, t) : a.type === 6 && (u = new xt(o, this, t)), this._$AV.push(u), a = s[++h];
      }
...
Tt?.(M, O), (F.litHtmlVersions ??= []).push("3.3.2");
const Mt = (r, t, e) => {
...
const zt = { attribute: !0, type: String, converter: R, reflect: !1, hasChanged: q }, Nt = (r = zt, t, e) => {
...
let l = class extends C {
  ...
  set_style_properties() {
    if (this.onStyleLogic) {
      this.onStyleLogic(this);
      return;
    }
  ...
  getArrows() {
    return this.handleType == "minimal" ? "" : z`<div class="arrow one">${this.arrowSvg}</div>
  ...
  _updateTargetFromPointer(r) {
    if (this.onMoveLogic) {
      ...
      this._targetProgress = this.onMoveLogic(r, t, this.angle), console.log(this._targetProgress);
    }
  }
  // ! ||--------------------------------------------------------------------------------||
  // ! ||                                   Focused Logic                                 ||
...
d([
  c({ attribute: !1 })
], l.prototype, "onMoveLogic", 2);
d([
  c({ attribute: !1 })
], l.prototype, "onStyleLogic", 2);
d([
  c({ type: String })
